...
\begin{longtable}[]{@{}c>{\raggedright\arraybackslash}p{7cm}l@{}}
...
La \cref{tab:plan-de-tratamiento-y-riesgo-residual} consigna el tratamiento previsto para cada riesgo identificado y el nivel residual estimado al cierre de la etapa actual. Se indica asimismo el actor responsable, considerando el esquema de responsabilidad compartida mencionado al inicio del apartado.
